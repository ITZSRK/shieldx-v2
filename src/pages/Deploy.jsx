        ...
        <section className="max-w-2xl mx-auto px-8 py-12 text-center">
          <Motion>
            ...
            <p className="text-white/55 text-[13.5px] max-w-lg mx-auto leading-relaxed">
              No. Partners execute. ShieldX Rails is there for an institution with no pipes of its
              own, or one that wants a clean holdout — and it is measured like every other partner.
            </p>
