...
function LiveDecisionTrace() {
  const stages = [
    ...
    { ms:"·",    label:"Record written",      sub:"hash-chained · AUD-20260614-48321",     highlight:false },
  ];
...
function EngineArchitecture() {
  ...
  const stages = [
    ...
    { num:"08", name:"System of Record",  group:"RECORD",   color:"emerald", desc:"Writes a tamper-evident, hash-chained, append-only record per decision: payload, the rule waterfall evaluated, the rule that fired, where it was directed and what came back — retrievable per account, with an integrity-verification endpoint and an audit row on every read." },
