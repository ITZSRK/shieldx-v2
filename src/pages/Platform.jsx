...
function EngineArchitecture() {
  ...
  const stages = [
    ...
    { num:"08", name:"System of Record",  group:"RECORD",   color:"emerald", desc:"Writes a hash-chained, append-only record per decision: payload, the rule waterfall evaluated, the rule that fired, where it was directed and what came back — retrievable per account, with an audit row on every read." },
